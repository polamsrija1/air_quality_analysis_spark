...
- ✅ Trained Spark MLlib Linear Regression model
- 📁 Saved to: `Output/section4_model/`
- 📄 Predictions CSV (actual vs predicted PM2.5)
- 📁 Saved to: `Output/section4_predictions/`

---

## 🔁 Real-Time Integration Plan (Next Stage)
Stream new sensor readings (TCP/Kafka)

Apply same feature transformation

Use the trained model to predict PM2.5

Display results on a real-time dashboard or trigger alerts
